    ...
    <>
      ...
      >
        <div className="container mx-auto px-6 flex justify-between items-center">
          <MagneticButton>
            <Link to="/" className="text-2xl font-display font-bold tracking-tighter text-white hover:text-gray-300 transition-colors interactive drop-shadow-md">
              MAURO ROCHA
            </Link>
          </MagneticButton>
          ...
          <nav className="hidden md:flex gap-8 items-center">
            ...
            <MagneticButton>
              <Link to="/admin" className={`transition-colors drop-shadow-md ${isAuthenticated ? 'text-red-500 hover:text-red-400' : 'text-white/50 hover:text-white'}`}>
          ...
          <div className="md:hidden flex items-center gap-4">
            <MagneticButton onClick={toggleLanguage}>
              <span className="text-xs font-bold uppercase text-white drop-shadow-md">{language === 'pt-BR' ? 'EN' : 'PT-BR'}</span>
            </MagneticButton>
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <nav className="flex flex-col gap-8 text-center">
              ...
              <MagneticButton>
                <Link to="/admin" onClick={() => setIsMenuOpen(false)} className="text-2xl text-gray-500 mt-8 hover:text-white transition-colors flex items-center gap-2 justify-center">
                   <Lock className="w-6 h-6" /> Admin Area
                </Link>
              </MagneticButton>
            </nav>
          </motion.div>
