...
export const Footer: React.FC = () => {
  ...
  return (
    <footer id="contact" className="py-24 px-6 bg-black/80 backdrop-blur-xl border-t border-white/10 relative z-20">
      <div className="container mx-auto flex flex-col items-center text-center">
        ...
        <div className="flex gap-8 mb-16">
          <MagneticButton className="relative hover:z-50">
             <a href="https://github.com/mauro-rocha-old" target="_blank" rel="noopener noreferrer" className="block p-4 bg-white/5 border border-white/10 rounded-full hover:bg-blue-600 hover:text-white hover:border-blue-500 transition-all duration-300 hover:scale-125 hover:shadow-[0_0_30px_rgba(37,99,235,0.8)] interactive group relative overflow-hidden">
          ...
          <MagneticButton className="relative hover:z-50">
             <a href="https://www.linkedin.com/in/mauro-lucio-rocha/" target="_blank" rel="noopener noreferrer" className="block p-4 bg-white/5 border border-white/10 rounded-full hover:bg-blue-600 hover:text-white hover:border-blue-500 transition-all duration-300 hover:scale-125 hover:shadow-[0_0_30px_rgba(37,99,235,0.8)] interactive group relative overflow-hidden">
               <div className="relative z-10">
          ...
          <MagneticButton className="relative hover:z-50">
             <a href="https://www.instagram.com/mauro_lucio_0" target="_blank" rel="noopener noreferrer" className="block p-4 bg-white/5 border border-white/10 rounded-full hover:bg-blue-600 hover:text-white hover:border-blue-500 transition-all duration-300 hover:scale-125 hover:shadow-[0_0_30px_rgba(37,99,235,0.8)] interactive group relative overflow-hidden">
               <div className="relative z-10">
